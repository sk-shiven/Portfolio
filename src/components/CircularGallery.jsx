...
const DEFAULT_FONT = 'italic 14px "Cormorant Garamond"';
// Cormorant Garamond is not guaranteed to be available on the host page, so the component
// loads it on demand whenever the default font is used.
const DEFAULT_FONT_URL = 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,700;1,400&display=swap';
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `/gallery/Hackathon_night.jpg`, text: 'Hackathon night' },
      { image: `/gallery/Clg_MUN_OC.jpeg`, text: 'MUN Secretariat' },
      { image: `/gallery/Culturals.jpg`, text: 'Culturals' },
      { image: `/gallery/Fest.jpeg`, text: 'Fest' },
      { image: `/gallery/Mentorship_Sessions.jpeg`, text: 'Tech Talks' },
      { image: `/gallery/Post_run_trek.jpg`, text: 'Trek' },
      { image: `/gallery/Volunteering.jpeg`, text: 'Volunteering' },
      { image: `/gallery/Certs_over_the_years.jpeg`, text: 'Journey so far' },
      { image: `/gallery/Vision_Board.jpeg`, text: 'Vision' }
    ];
...
export default function CircularGallery({
  ...
  }, [items, bend, textColor, borderRadius, font, fontUrl, scrollSpeed, scrollEase, autoScroll]);
  return (
    <div
