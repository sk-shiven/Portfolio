...
const LabCard = ({ 
  number = "001",
  title = "OURO-DS",
  description = "A brutalist, high-performance design system highlighting robust typography and micro-interactions.",
    ...
    <div className={`w-full ${bgClass} ${textClass} px-8 py-12 md:py-20 group cursor-pointer border border-zinc-900 transition-colors mb-4 last:mb-0`}>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        ...
        <div className="w-full md:w-1/4 flex justify-start md:justify-end">
          <a href="#" className="font-mono text-sm tracking-widest font-bold uppercase hover:opacity-70 transition-opacity flex items-center gap-2">
